...
// dot.c
//
// Functions for writing graphs in dot format.  The dot format is part of AT&T 
// Labs GraphViz project.
//
// Date      Name       Description
// ========  =========  ========================================================
// 11/30/09  Eberle     Initial version, taken from SUBDUE 5.2.1
...
// NAME: get_color
//
// INPUTS: (COLOR color) - color to convert to string
//
// RETURN: (char *)
//
// PURPOSE: Converts a COLOR value into a string for use in a dot file.
// NOTE: the string returned should NOT be freed.
//******************************************************************************
...
void WriteGraphToDotFile(char *dotFileName, Parameters *parameters)
{
   ...
   LabelList *labelList = parameters->originalLabelList;
   posGraph = parameters->originalPosGraph;
   ...
   fprintf(dotFile, "// GBAD %s graph in dot format\n\n", GBAD_VERSION);
   fprintf(dotFile, "digraph GBADGraph {\n");
                        ...
                        ULONG numSubGraphs, Parameters *parameters)
{
   ...
   // write beginning of dot file
   fprintf(dotFile, "// GBAD %s output in dot format\n\n", GBAD_VERSION);
   fprintf(dotFile, "digraph GBAD {\n\n");
                        ...
                        Graph *graph, LabelList *labelList, char *color)
{
   ...
   char *edge_color = get_color(edge->color);
