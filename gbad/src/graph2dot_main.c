...
// graph2dot_main.c
//
// Main functions for program to convert a graph input file into dot format as 
// specified in AT&T Labs GraphViz package.
//
// Usage: graph2dot <graphfilename> <dotfilename>
//
// Writes the graph defined in <graphfilename> to <dotfilename> in dot format.
//
